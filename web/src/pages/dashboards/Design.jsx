...
export default function DesignDashboard() {
  ...
  const handleStartQuiz = (assignment, quiz) => {
    ...
    navigate('/design/quiz', { state: { assignment, quiz } });
  };
    ...
    <>
      ...
      <div className="container my-4" style={{maxWidth:1200}}>
        <div className="text-center mb-4">
          ...
          <h1 className="display-4 fw-bold text-gradient mb-3">Design Team Dashboard</h1>
            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="card h-100 border-0 glass-card hover-lift">
                <div className="card-body">
                  ...
                  <Link to="/design/games" className="btn btn-outline-primary btn-sm">
                    Play Games
                  </Link>
                </div>
              </div>
            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="card h-100 border-0 glass-card hover-lift">
                <div className="card-body">
                  ...
                  <Link to="/design/progress" className="btn btn-outline-primary btn-sm">
                    View Progress
                  </Link>
                </div>
              </div>
                  ...
                  {facts.map((fact) => {
                    ...
                    return (
                      <div key={fact.id} className={isRead ? 'opacity-75' : ''}>
                        <NotificationCard 
                          fact={fact}
                          onMarkRead={() => markFactRead(fact.id)}
                          disabled={isRead}
                        />
                      </div>
                    );
